  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycbx8PuwyphkU05WdtXT91gvetpll2fuyTXZtPws1sPZRixCzqUxazggIbzc45Z1rd0nr/exec",
        {
          method: "POST",
          mode: "no-cors",
          headers: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Admissions are open for Academic Coaching (Classes 5–12) and
              Spoken English batches. Limited seats — don't miss out!
            </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onFocus={(e) =>
                        (e.target.style.borderColor = "hsl(var(--brand-blue))")
                      }
                      onBlur={(e) =>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      value={form.cls}
                      onChange={(e) =>
                        setForm({ ...form, cls: e.target.value })
                      }
